...
const char *studySelectChoices[] = {"1. Balance", "2. Athletics"};
float PIDChoices[] = {1, 1, 100};
int studySelect = 1;
int PIDSelect = 1;
...
const char *limbMenuChoices[] = {"1. Right", "2. Left"};

const char *screenStartMenuChoices[] = {"1. Begin", "2. New movement", "3. New session", "4. Exit"};
String incomingMsg;
...
float leftForce, rightForce, Force, Time, COPx, COPy, COPx_prev, COPy_prev, ML_Range, AP_Range, swayVel;

int state, count, page;
bool IC_Prev1;
